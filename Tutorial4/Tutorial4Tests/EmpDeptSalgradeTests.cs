...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        List<Emp> result = emps.Where(e=> e.DeptNo == 30).ToList().OrderBy(e=>e.DeptNo).ToList(); 
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Dept> subresult = depts.Where(d => d.Loc == "Chicago").ToList();
        List<Emp> result = emps.Where(e=> subresult.Select(d=>d.DeptNo).Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(emp => grades.Where(g => emp.Sal >= g.Losal && emp.Sal <= g.Hisal ).Select(g => new {emp.EName, g.Grade})).ToList();
